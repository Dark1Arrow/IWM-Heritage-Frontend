...
import { Star, Heart, MessageSquare, Plus, Info } from "lucide-react";
...
const ReviewsSection = ({ heritageId }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-12 py-16 bg-white">
      <div className="flex flex-col md:flex-row gap-12 items-start mb-16">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-3">
            {reviews.map((star) => {
              // Calculate width based on stats API. Assuming stats.distribution[star] exists
      ...
      {addReview && <AddReview onClose={() => setAddReview(false)}/>}
    </div>
  );
};
